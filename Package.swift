...
let package = Package(
    ...
    products: [
        ...
        .library(
            name: "SageSwiftKit",
            targets: ["SageSwiftKit"]
        ),
        .executable(
            name: "SageSwiftKitClient",
            targets: ["SageSwiftKitClient"]
        ),
    ],
    dependencies: [
        .package(url: "https://github.com/apple/swift-syntax.git", exact: "604.0.0-prerelease-2025-12-15")
    ],
    targets: [
